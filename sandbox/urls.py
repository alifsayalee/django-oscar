...
urlpatterns = [
    ...
    # JSON API for PayPal payments and saved cards. Lives outside
    # i18n_patterns so the routes are stable, language-independent URLs.
    path('api/', include('apps.payments_api.urls')),
