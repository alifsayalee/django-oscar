...
urlpatterns = [
    ...
    path("contact-numbers/<int:contact_number_id>", views.contact_number_detail, name="contact-number-detail"),
    ...
    path("notifications/<int:notification_id>/resend", views.resend_notification, name="notification-resend"),
