...
INSTALLED_APPS = [
    ...
    # Additive PayPal payments + saved-cards REST API (this sandbox project)
    'apps.paypal_api',
]
...
# PayPal settings
# ==============
# Read from the environment at run time. Never hard-code the credential values
# here (or anywhere in the repo). PAYPAL_BASE_URL is an optional override; when
# set it is used verbatim for every PayPal call, including the token request.
